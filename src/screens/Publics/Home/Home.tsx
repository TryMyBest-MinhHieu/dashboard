...
import useSlideServicesQuery from '@/services/DA_Slide/index.ts';
function HomePage() {
  const {data, isLoading} = useSlideServicesQuery.getListSlideHomeQuery();
  ...
  return (
    <div>
      <section className="w-full">
        ...
        {data?.items && <HomeSlideComponent slides={data.items} />}
      </section>
